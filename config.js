...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'FEENIX MD' : process.env.BOT_NAME,
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'FEENIX MD' : process.env.PACK_INFO.split(";")[1],
  ...
  LANG: process.env.THEME|| 'FEENIX-MD',
